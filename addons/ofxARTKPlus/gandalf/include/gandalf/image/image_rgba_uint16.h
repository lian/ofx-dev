/**
 * File:          $RCSfile: image_rgba_uint16.h,v $
 * Module:        RGB colour 16-bit images with alpha channel
...
#ifndef _GAN_IMAGE_RGBA_UINT16_H
#define _GAN_IMAGE_RGBA_UINT16_H
...
#define gan_image_form_gen_rgba_ui16(img,h,w,s,a,pdata,pdsize,rdata,rdsize) \
        gan_image_form_gen_rgba_us(img,h,w,s,a,pdata,pdsize,rdata,rdsize)
#define gan_image_set_gen_rgba_ui16(img,h,w,s,a) \
        gan_image_set_gen_rgba_us(img,h,w,s,a)
#define gan_image_set_pix_rgba_ui16(img,row,col,val) \
        gan_image_set_pix_rgba_us(img,row,col,val)
#define gan_image_get_pix_rgba_ui16(img,row,col) \
        gan_image_get_pix_rgba_us(img,row,col)
#define gan_image_get_pixptr_rgba_ui16(img,row,col) \
        gan_image_get_pixptr_rgba_us(img,row,col)
#define gan_image_get_pixarr_rgba_ui16(img) \
        gan_image_get_pixarr_rgba_us(img)
#define gan_image_fill_const_rgba_ui16(img,val) \
        gan_image_fill_const_rgba_us(img,val)
#define gan_image_alloc_rgba_ui16(h,w) gan_image_alloc_rgba_us(h,w)
#define gan_image_form_rgba_ui16(img,h,w) gan_image_form_rgba_us(img,h,w)
#define gan_image_alloc_data_rgba_ui16(h,w,s,pd,pds,rd,rds) \
        gan_image_alloc_data_rgba_us(h,w,s,pd,pds,rd,rds)
#define gan_image_form_data_rgba_ui16(img,h,w,s,pd,pds,rd,rds) \
        gan_image_form_data_rgba_us(img,h,w,s,pd,pds,rd,rds)
#define gan_image_set_rgba_ui16(img,h,w) gan_image_set_rgba_us(img,h,w)
...
#endif /* #ifndef _GAN_IMAGE_RGBA_UINT16_H */
