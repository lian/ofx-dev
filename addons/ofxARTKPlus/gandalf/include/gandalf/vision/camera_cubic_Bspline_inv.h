/**
 * File:          $RCSfile: camera_cubic_Bspline_inv.h,v $
...
#ifndef _GAN_CAMERA_CUBIC_BSPLINE_INV_H
#define _GAN_CAMERA_CUBIC_BSPLINE_INV_H
...
GANDALF_API Gan_Bool gan_camera_build_cubic_Bspline_inv ( Gan_Camera *camera,
                                                          double zh,
                                                          double fx, double fy,
                                                          double x0, double y0,
