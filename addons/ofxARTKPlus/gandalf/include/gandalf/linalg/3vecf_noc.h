...
GANDALF_API Gan_Vector3_f *gan_vec3f_fill_q ( Gan_Vector3_f *p,
                                  float X, float Y, float Z );
#else
#define gan_vec3f_fill_q(p,X,Y,Z) (GAN_FREP3_A_C((p)->,=,(X),(Y),(Z)),p)
#endif
 ...
 */
#ifdef GAN_GENERATE_DOCUMENTATION
GANDALF_API Gan_Vector3_f *gan_vec3f_cross_q ( const Gan_Vector3_f *p, const Gan_Vector3_f *q,
                                   Gan_Vector3_f *r );
#else
#define gan_vec3f_cross_q(p,q,r) \
  (GAN_TEST_OP3(p,q,r,Gan_Vector3_f,Gan_Vector3_f,Gan_Vector3_f),\
   assert((r)!=(p)&&(r)!=(q)),\
   (r)->x=(p)->y*(q)->z-(p)->z*(q)->y,\
   (r)->y=(p)->z*(q)->x-(p)->x*(q)->z,\
 ...
 */
#ifdef GAN_GENERATE_DOCUMENTATION
GANDALF_API Gan_Vector2_f *gan_vec3f_get_v2t_q ( const Gan_Vector3_f *p, Gan_Vector2_f *q );
#else
#define gan_vec3f_get_v2t_q(p,q)\
           (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector2_f),\
            GAN_REP2_AA_C((q)->,=(p)->),q)
#endif
 ...
 */
#ifdef GAN_GENERATE_DOCUMENTATION
GANDALF_API Gan_Vector3_f *gan_vec3f_set_parts_q ( Gan_Vector3_f *p,
                                       const Gan_Vector2_f *q, float s );
#else
#define gan_vec3f_set_parts_q(p,q,s)\
           (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector2_f),\
...
GANDALF_API Gan_Vector3_f gan_vec3f_fill_s ( float X, float Y, float Z );
GANDALF_API Gan_Vector3_f gan_vec3f_set_parts_s ( const Gan_Vector2_f *q, float s );
GANDALF_API Gan_Vector2_f gan_vec3f_get_v2t_s ( const Gan_Vector3_f *p );
GANDALF_API Gan_Vector3_f gan_vec3f_cross_s ( const Gan_Vector3_f *p, const Gan_Vector3_f *q );
...
#define gan_vec3f_zero_q(p) (GAN_TEST_OP1(p,Gan_Vector3_f),\
                            GAN_REP3_AS_C((p)->,=0.0),p)
#define gan_vec3f_copy_q(p,q) (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector3_f),\
                              GAN_REP3_AA_C((q)->,=(p)->),q)
#define gan_vec3f_scale_q(p,a,q) (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector3_f),\
                                 GAN_REP3_AAS_C((q)->,=(p)->,*(a)),q)
#define gan_vec3f_scale_i(p,a) gan_vec3f_scale_q(p,a,p)
#define gan_vec3f_divide_q(p,a,q) (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector3_f),\
                                  (a)==0.0 ? NULL :\
                                  (GAN_REP3_AAS_C((q)->,=(p)->,/(a)),q))
#define gan_vec3f_divide_i(p,a) gan_vec3f_divide_q(p,a,p)
#define gan_vec3f_unit_i(p) gan_vec3f_unit_q(p,p)
#define gan_vec3f_negate_q(p,q) (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector3_f),\
                                GAN_REP3_AA_C((q)->,= -(p)->),q)
#define gan_vec3f_negate_i(p) gan_vec3f_negate_q(p,p)
#define gan_vec3f_add_q(p,q,r)\
           (GAN_TEST_OP3(p,q,r,Gan_Vector3_f,Gan_Vector3_f,Gan_Vector3_f),\
            GAN_REP3_AAA_C((r)->,=(p)->,+(q)->),r)
#define gan_vec3f_add_i1(p,q) gan_vec3f_add_q(p,q,p)
#define gan_vec3f_add_i2(p,q) gan_vec3f_add_q(p,q,q)
#define gan_vec3f_increment(p,q) gan_vec3f_add_i1(p,q)
#define gan_vec3f_sub_q(p,q,r)\
           (GAN_TEST_OP3(p,q,r,Gan_Vector3_f,Gan_Vector3_f,Gan_Vector3_f),\
            GAN_REP3_AAA_C((r)->,=(p)->,-(q)->),r)
#define gan_vec3f_sub_i1(p,q) gan_vec3f_sub_q(p,q,p)
#define gan_vec3f_sub_i2(p,q) gan_vec3f_sub_q(p,q,q)
#define gan_vec3f_decrement(p,q) gan_vec3f_sub_i1(p,q)
#define gan_vec3f_dot_q(p,q) (GAN_TEST_OP2(p,q,Gan_Vector3_f,Gan_Vector3_f),\
                             GAN_REP3_OP_AA_C((p)->,*(q)->,+))
#define gan_vec3f_sqrlen_q(p) gan_vec3f_dot_q(p,p)
#endif /* #ifndef GAN_GENERATE_DOCUMENTATION */
