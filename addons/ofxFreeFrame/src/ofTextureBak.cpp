...
//----------------------------------------------------------
ofTextureBak::ofTextureBak(const ofTextureBak& mom){
	textureName[0] = 0;
	bFlipTexture = false;
	if (GLEE_ARB_texture_rectangle){
		textureTarget = GL_TEXTURE_RECTANGLE_ARB;
...
//----------------------------------------------------------
void ofTextureBak::loadData(unsigned char * data, int w, int h, int glDataType){
...
//----------------------------------------------------------
void ofTextureBak::loadScreenData(int x, int y, int w, int h){
...
//----------------------------------------------------------
void ofTextureBak::draw(float x, float y){
