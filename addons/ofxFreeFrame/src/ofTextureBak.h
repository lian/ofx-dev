#ifndef _IMAGE_TEXTURE_BAK_H_
#define _IMAGE_TEXTURE_BAK_H_
...
class ofTextureBak {
	...
	public :
		...
		ofTextureBak(const ofTextureBak& mom); 				// don't allow pass by copy				
		ofTextureBak& operator=(const ofTextureBak& mom); 	// don't allow use of =
		// -----------------------------------------------------------------------
