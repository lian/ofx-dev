/**
 * File:          $RCSfile: cameraf_cubic_Bspline_inv.h,v $
...
#ifndef _GAN_CAMERAF_CUBIC_BSPLINE_INV_H
#define _GAN_CAMERAF_CUBIC_BSPLINE_INV_H
...
GANDALF_API Gan_Bool gan_cameraf_build_cubic_Bspline_inv ( Gan_Camera_f *camera,
                                                           float zh,
                                                           float fx, float fy,
                                                           float x0, float y0,
